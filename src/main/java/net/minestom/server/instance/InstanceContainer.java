...
public class InstanceContainer extends Instance {
    ...
    private synchronized void UNSAFE_setBlock(@NotNull Chunk chunk, int x, int y, int z, @NotNull Block block,
        ...
        synchronized (chunk) {
            ...
            PreBlockChangeEvent preBlockChangeEvent = new PreBlockChangeEvent(blockPosition, previousBlock, block,
                    this);
            EventDispatcher.call(preBlockChangeEvent);
            if(preBlockChangeEvent.isCancelled()) {
                return;
            }
            ...
            if(preBlockChangeEvent.syncClient()) {
